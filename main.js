...
__export(main_exports, {
  default: () => NoteToSocialImagePlugin
});
...
function stripMarkdown(text) {
  return text.replace(/#{1,6}\s+/g, "").replace(/\*\*(.+?)\*\*/g, "$1").replace(/__(.+?)__/g, "$1").replace(/\*(.+?)\*/g, "$1").replace(/_(.+?)_/g, "$1").replace(/`{1,3}[^`]*`{1,3}/g, "").replace(/\[(.+?)\]\(.+?\)/g, "$1").replace(/!\[\[.+?\]\]/g, "").trim();
}
var CARD_WIDTH = 750;
var STYLES = [
  // ================================================================
...
<div style="width:${CARD_WIDTH}px; background:linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding:60px 50px 50px; font-family:-apple-system,'PingFang SC','Hiragino Sans GB',sans-serif; border-radius:28px; box-sizing:border-box; position:relative; overflow:hidden;">
  ...
  <div style="background:rgba(255,255,255,0.15);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-radius:20px;border:1px solid rgba(255,255,255,0.25);padding:36px 32px;position:relative;">
    ...
    <div style="font-size:15px;color:rgba(255,255,255,0.92);line-height:2;letter-spacing:0.2px;">
      ${lines.map(
        (l, i) => i === 0 && l.length < 30 ? `<div style="font-size:19px;font-weight:600;color:#FFFFFF;margin-bottom:12px;">${l}</div>` : `<div style="margin-bottom:6px;">${l}</div>`
      ).join("")}
    </div>
  </div>
...
<div style="width:${CARD_WIDTH}px; background:#FBFBFB; padding:0; font-family:'Helvetica Neue',-apple-system,'PingFang SC',sans-serif; border-radius:0; box-sizing:border-box; position:relative; overflow:hidden; border:1px solid #E8E8E8;">
  ...
  <div style="padding:48px 44px 40px;">
    ...
    <div style="font-size:15px;color:#3A3A3A;line-height:2;letter-spacing:0.2px;font-weight:400;">
      ${lines.map(
        (l, i) => i === 0 ? `<div style="font-size:18px;font-weight:600;color:#1A1A1A;margin-bottom:14px;">${l}</div>` : l.startsWith("- ") || l.startsWith("\u2022 ") ? `<div style="padding-left:20px;position:relative;margin-bottom:4px;"><span style="position:absolute;left:0;color:#E53935;font-weight:700;">\u2014</span>${l.replace(/^[-•]\s*/, "")}</div>` : `<div style="margin-bottom:6px;">${l}</div>`
      ).join("")}
    </div>
...
<div style="width:${CARD_WIDTH}px; background:#1A1817; padding:52px 44px 44px; font-family:'Georgia','Times New Roman','PingFang SC',serif; border-radius:16px; box-sizing:border-box; position:relative; overflow:hidden;">
  ...
  <div style="position:relative;z-index:1;">
    ...
    <div style="font-size:16px;color:#B8956E;line-height:2.2;letter-spacing:0.3px;">
      ${lines.map(
        (l, i) => i === 0 ? `<div style="font-size:18px;color:#D4A574;margin-bottom:14px;font-style:italic;">${l}</div>` : `<div style="margin-bottom:8px;color:#C8B8A8;">${l}</div>`
      ).join("")}
    </div>
...
<div style="width:${CARD_WIDTH}px; background:#FFFBE6; padding:0; font-family:'Arial Black','Impact','PingFang SC',sans-serif; box-sizing:border-box; position:relative; border:5px solid #000000; box-shadow:12px 12px 0 #000000;">
  <div style="padding:44px 38px 38px;">
    ...
    <div style="font-size:16px;color:#000000;line-height:1.9;font-weight:700;font-family:-apple-system,'PingFang SC',sans-serif;">
      ${lines.map(
        (l, i) => i === 0 ? `<div style="background:#000000;color:#FFE600;padding:12px 16px;margin-bottom:16px;font-size:17px;display:inline-block;">${l}</div>` : `<div style="margin-bottom:10px;padding:4px 0;border-bottom:3px solid #000000;">${l}</div>`
      ).join("")}
    </div>
  ...
  <div style="position:relative;z-index:1;">
    ...
    <div style="font-size:15px;color:#6B5B62;line-height:2.1;letter-spacing:0.3px;">
      ${lines.map((l, i) => {
        ...
        if (l.startsWith("- ") || l.startsWith("\u2022 ")) return `<div style="padding-left:16px;margin-bottom:4px;color:#8B7D84;"><span style="color:#C4A8B8;">\xB7</span> ${l.replace(/^[-•]\s*/, "")}</div>`;
...
<div style="width:${CARD_WIDTH}px; background:linear-gradient(150deg, #0F2027 0%, #203A43 50%, #2C5364 100%); padding:56px 48px 48px; font-family:-apple-system,'PingFang SC','Hiragino Sans GB',sans-serif; border-radius:24px; box-sizing:border-box; position:relative; overflow:hidden;">
  ...
  <div style="font-size:15px;color:rgba(255,255,255,0.85);line-height:2;letter-spacing:0.3px;">
    ${lines.map(
        (l, i) => i === 0 ? `<div style="font-size:18px;font-weight:600;color:#FFE66D;margin-bottom:14px;">${l}</div>` : `<div style="margin-bottom:6px;color:rgba(255,255,255,0.7);">${l}</div>`
      ).join("")}
  </div>
...
<div style="width:${CARD_WIDTH}px; background:#FFFDF7; padding:0; font-family:'Comic Sans MS','Chalkboard SE',-apple-system,'PingFang SC',sans-serif; border-radius:4px; box-sizing:border-box; position:relative; overflow:hidden; border:3px solid #000000;">
  ...
  <div style="padding:48px 40px 44px;">
    ...
    <div style="font-size:14px;color:#1A1A2E;line-height:2;">
      ${lines.map(
        (l, i) => i === 0 ? `<div style="background:#FFE66D;display:inline-block;padding:6px 14px;margin-bottom:14px;font-weight:700;border:2px solid #000;">${l}</div>` : `<div style="margin-bottom:8px;padding:4px 0;">${l}</div>`
      ).join("")}
    </div>
...
<div style="width:${CARD_WIDTH}px; background:#FAFAF7; padding:64px 56px 48px; font-family:'Georgia','Times New Roman','STSong','PingFang SC',serif; border-radius:4px; box-sizing:border-box; position:relative;">
  ...
  <div style="font-size:11px;color:#999;letter-spacing:3px;text-transform:uppercase;margin-bottom:32px;font-family:-apple-system,sans-serif;">${getTimeStr()} \xB7 OBSIDIAN NOTES</div>
...
var StylePickerModal = class extends import_obsidian.Modal {
  constructor(app, plugin, selectedText, noteTitle, onChoose) {
    super(app);
  ...
  onOpen() {
    ...
    header.createEl("h2", { text: "\u{1F3A8} \u9009\u62E9\u5206\u4EAB\u98CE\u683C", cls: "ntsi-modal-title" });
    header.createEl("div", { text: "\u6309 1-6 \u5FEB\u901F\u9009\u62E9 \xB7 Esc \u5173\u95ED", cls: "ntsi-hint" });
    ...
    setTimeout(() => {
      const firstCard = grid.querySelector(".ntsi-style-card");
      firstCard?.focus();
    }, 100);
  }
  updatePreview(index) {
...
var NoteToSocialImagePlugin = class extends import_obsidian.Plugin {
  async onload() {
    ...
    this.addCommand({
      ...
      editorCallback: (editor, view) => {
        ...
        if (!selection) {
          new import_obsidian.Notice("\u26A0\uFE0F \u8BF7\u5148\u9009\u4E2D\u8981\u5206\u4EAB\u7684\u6587\u5B57");
          return;
        }
    ...
    this.addRibbonIcon("image-up", "\u5BFC\u51FA\u4E3A\u5206\u4EAB\u56FE\u7247", (evt) => {
      const view = this.app.workspace.getActiveViewOfType(import_obsidian.MarkdownView);
      if (!view) {
        new import_obsidian.Notice("\u26A0\uFE0F \u8BF7\u6253\u5F00\u4E00\u4E2A\u7B14\u8BB0");
        return;
      }
    ...
    this.registerEvent(
      this.app.workspace.on("editor-menu", (menu, editor, view) => {
        ...
        const noteTitle = view.file?.basename ?? "\u672A\u547D\u540D\u7B14\u8BB0";
        menu.addItem((item) => {
          item.setTitle("\u5BFC\u51FA\u4E3A\u5206\u4EAB\u56FE\u7247").setIcon("image-up").setSection("action").onClick(() => this.openStylePicker(selection, noteTitle));
        });
        const defaultStyle = STYLES.find((s) => s.id === this.settings.defaultStyle) ?? STYLES[0];
        menu.addItem((item) => {
          item.setTitle(`\u5FEB\u901F\u5BFC\u51FA: ${defaultStyle.icon} ${defaultStyle.name}`).setIcon("zap").setSection("action").onClick(() => this.exportAsImage(selection, noteTitle, defaultStyle));
        });
      })
    );
    this.addSettingTab(new NoteToSocialImageSettingTab(this.app, this));
    console.log("\u{1F4F8} Note to Social Image plugin loaded!");
  }
  onunload() {
    console.log("\u{1F4F8} Note to Social Image plugin unloaded");
  }
  async loadSettings() {
  ...
  async exportAsImage(text, title, style, retryCount = 0) {
    ...
    try {
      ...
      updateNotice("\u{1F4BE} \u6B63\u5728\u4FDD\u5B58...");
      const blob = await new Promise((resolve) => {
        canvas.toBlob((b) => resolve(b), "image/png", 1);
      });
      const folderPath = (0, import_obsidian.normalizePath)(this.settings.exportFolder);
      ...
      notice.hide();
      const successNotice = new import_obsidian.Notice("", 8e3);
      ...
      if (copiedToClipboard) {
        msgText.createEl("span", { text: " \xB7 \u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F", cls: "ntsi-copied" });
      }
      const actions = msgEl.createEl("div", { cls: "ntsi-success-actions" });
      const viewBtn = actions.createEl("button", { text: "\u{1F441} \u67E5\u770B\u56FE\u7247", cls: "ntsi-action-btn" });
      viewBtn.addEventListener("click", () => {
        const file2 = this.app.vault.getAbstractFileByPath(filePath);
        if (file2 instanceof import_obsidian.TFile) {
          this.app.workspace.getLeaf("tab").openFile(file2);
        }
        successNotice.hide();
      });
      const revealBtn = actions.createEl("button", { text: "\u{1F4C2} \u6253\u5F00\u76EE\u5F55", cls: "ntsi-action-btn" });
      ...
      notice.hide();
      if (retryCount < 2) {
        new import_obsidian.Notice(`\u26A0\uFE0F \u7B2C${retryCount + 1}\u6B21\u5931\u8D25\uFF0C\u6B63\u5728\u91CD\u8BD5...`);
        await new Promise((r) => setTimeout(r, 500));
        return this.exportAsImage(text, title, style, retryCount + 1);
      }
      new import_obsidian.Notice(`\u274C \u5BFC\u51FA\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5\u6216\u68C0\u67E5\u63A7\u5236\u53F0`);
      console.error("Note to Social Image error:", err);
    }
  }
};
var NoteToSocialImageSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    containerEl.createEl("h2", { text: "\u{1F4F8} Note to Social Image \u8BBE\u7F6E" });
    new import_obsidian.Setting(containerEl).setName("\u9ED8\u8BA4\u98CE\u683C").setDesc("\u5FEB\u901F\u5BFC\u51FA\u65F6\u4F7F\u7528\u7684\u98CE\u683C").addDropdown((dropdown) => {
      STYLES.forEach((s) => {
    ...
    new import_obsidian.Setting(containerEl).setName("\u5BFC\u51FA\u76EE\u5F55").setDesc("\u56FE\u7247\u4FDD\u5B58\u4F4D\u7F6E\uFF08\u76F8\u5BF9\u4E8E vault \u6839\u76EE\u5F55\uFF09").addText((text) => text.setPlaceholder("attachments/social-images").setValue(this.plugin.settings.exportFolder).onChange(async (value) => {
